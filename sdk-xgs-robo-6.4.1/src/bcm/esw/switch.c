                            ...
                            bcm_switch_control_t type, int *arg)
{
    ...
    if (SOC_IS_TD2_TT2(unit) &&
        ...
        count = COUNTOF(hash_select_control_td2);
    } else
#endif
    if (SOC_IS_TD_TT(unit) || SOC_IS_TRIUMPH3(unit) ||
        SOC_IS_KATANA(unit)) {
...
defined(BCM_TRIDENT_SUPPORT)
    ...
    { bcmSwitchIpmcSameVlanPruning, TD,
        ...
        _bool_invert, 0 },
    { bcmSwitchHashNivSrcIfEtagSvidSelect0, TD | TR3 | HX4 | KT | TD2,
        RTAG7_HASH_CONTROL_2r, RTAG7_HASH_BIN_0_SELECT_Af,
        NULL, 0 },
    { bcmSwitchHashNivSrcIfEtagSvidSelect1, TD | TR3 | HX4 | KT | TD2,
        RTAG7_HASH_CONTROL_2r, RTAG7_HASH_BIN_0_SELECT_Bf,
        NULL, 0 },
    { bcmSwitchHashNivDstIfEtagVidSelect0, TD | TR3 | HX4 | KT | TD2,
        RTAG7_HASH_CONTROL_2r, RTAG7_HASH_BIN_1_SELECT_Af,
        NULL, 0 },
    { bcmSwitchHashNivDstIfEtagVidSelect1, TD | TR3 | HX4 | KT | TD2,
                                ...
                                int arg)
{
    ...
    defined(BCM_TRIDENT2_SUPPORT) || defined(BCM_GREYHOUND_SUPPORT)
        ...
        if(SOC_IS_GREYHOUND(unit)) {
            _bcm_gh_switch_control_port_binding_set(unit, port, type, arg, &found);
