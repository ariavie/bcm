                                 ...
                                 uint16 reg_addr, uint16 *data)
{
    ...
    PHY_BCM542XX_READ_RDB_REG(unit, pc, reg_addr, data);
...
int phy_bcm542xx_direct_reg_write(int unit, phy_ctrl_t *pc, uint16 reg_addr, uint16 data)
{
    ...
    PHY_BCM542XX_RDB_ACCESS_MODE(unit, pc);   /* set RDB register access mode */
    PHY_BCM542XX_WRITE_RDB_REG(unit, pc, reg_addr, data);
    PHY_BCM542XX_LEGACY_ACCESS_MODE(unit, pc);   /* legacy register access mode */
    return SOC_E_NONE;
}
                                   ...
                                   uint16 data, uint16 mask)
{
    ...
    PHY_BCM542XX_RDB_ACCESS_MODE(unit, pc);   /* set RDB register access mode */
    PHY_BCM542XX_MODIFY_RDB_REG(unit, pc, reg_addr, data, mask);
    PHY_BCM542XX_LEGACY_ACCESS_MODE(unit, pc);   /* legacy register access mode */
    return SOC_E_NONE;
}
...
STATIC int
_phy_bcm542xx_get_auto_eee_control_status(int unit, soc_port_t port, uint32 *value)
{
    int         rv = SOC_E_NONE;
    uint16      temp16 = 0;
    int         dev_port;
                              ...
                              uint16 reg_addr, uint32 *value32)
{
    ...
    PHY_BCM542XX_MODIFY_RDB_REG(unit, pc,
    ...
    PHY_BCM542XX_READ_RDB_REG(unit, pc, reg_addr, &msb1);    /* upper 16 bits */
    PHY_BCM542XX_READ_RDB_REG(unit, pc, reg_addr, &lsb1);    /* lower 16 bits */
    if ( PHY_IS_BCM54210_220(pc) ) {
        *value32 = (((uint32) msb1) << 16) | lsb1;
        ...
        PHY_BCM542XX_READ_RDB_REG(unit, pc, reg_addr, &msb2);
        PHY_BCM542XX_READ_RDB_REG(unit, pc, reg_addr, &lsb2);
        ...
        *value32 = ( lsb1 & BIT15 ) ? (((uint32) msb1) << 16) | lsb1
                                    : (((uint32) msb2) << 16) | lsb1;
    }
