...
0x0f00|((0xc0)&0xff),0x15,(l14&0x7fff)));bsl_verbose(BSL_SOC_PHY, BSL_UNIT_UNKNOWN,
...
bsl_verbose(BSL_SOC_PHY, BSL_UNIT_UNKNOWN,
"\t->ECD on demand not done - busy time out! (u:%d p:%d) \n",l1,l2) ;}if(l9&
0x0008){bsl_verbose(BSL_SOC_PHY, BSL_UNIT_UNKNOWN,"\t->ECD no fresh result! (u:%d p:%d)\n",
l1,l2) ;}if(l9&0x0004){bsl_verbose(BSL_SOC_PHY, BSL_UNIT_UNKNOWN,
"\t->ECD result invalid! (u:%d p:%d)\n",l1,l2) ;}}if((l12[2] == 0x47AE)||(l12
[3] == 0x47AE)||(l12[4] == 0x47AE)||(l12[5] == 0x47AE)){bsl_verbose(BSL_SOC_PHY,
BSL_UNIT_UNKNOWN,"\t->ECD failure type 183! (u:%d p:%d)\n",l1,l2) ;}if((l9&0xff)||(
(l12[2] == 0x47AE)||(l12[3] == 0x47AE)||(l12[4] == 0x47AE)||(l12[5] == 0x47AE
))){bsl_verbose(BSL_SOC_PHY, BSL_UNIT_UNKNOWN,"\t->EXP_C[0]: %x\n",l12[0]) ;bsl_verbose(
BSL_SOC_PHY,BSL_UNIT_UNKNOWN,"\t->EXP_C[1]: %x\n",l12[1]) ;bsl_verbose(BSL_SOC_PHY, BSL_UNIT_UNKNOWN,
"\t->EXP_C[2]: %x\n",l12[2]) ;bsl_verbose(BSL_SOC_PHY, BSL_UNIT_UNKNOWN,
"\t->EXP_C[3]: %x\n",l12[3]) ;bsl_verbose(BSL_SOC_PHY, BSL_UNIT_UNKNOWN,
"\t->EXP_C[4]: %x\n",l12[4]) ;bsl_verbose(BSL_SOC_PHY, BSL_UNIT_UNKNOWN,
...
pair_len[1] = l12[3]/100;break;case 9:bsl_verbose(BSL_SOC_PHY, BSL_UNIT_UNKNOWN,
...
pair_len[2] = l12[4]/100;break;case 9:bsl_verbose(BSL_SOC_PHY, BSL_UNIT_UNKNOWN,
...
pair_len[3] = l12[5]/100;break;case 9:bsl_verbose(BSL_SOC_PHY, BSL_UNIT_UNKNOWN,
...
l17 = SOC_E_FAIL;do{bsl_verbose(BSL_SOC_PHY, BSL_UNIT_UNKNOWN,
