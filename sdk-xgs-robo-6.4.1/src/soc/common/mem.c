               ...
               int index, void *entry_data)
{
    ...
    if (SOC_IS_ARAD(unit) && (copyno == SOC_CORE_ALL || copyno == COPYNO_ALL)) {
        switch (SOC_BLOCK_TYPE(unit, SOC_MEM_BLOCK_ANY(unit, mem))) {
        case SOC_BLK_EGQ:
            copyno_override = SOC_INFO(unit).brdc_egq_block;
            break;
        case SOC_BLK_IHB:
            copyno_override = SOC_INFO(unit).brdc_ihb_block;
            break;
        case SOC_BLK_IHP:
            copyno_override = SOC_INFO(unit).brdc_ihp_block;
            break;
        case SOC_BLK_IPS:
            copyno_override = SOC_INFO(unit).brdc_ips_block;
            break;
        case SOC_BLK_IQM:
            copyno_override = SOC_INFO(unit).brdc_iqm_block;
            break;
        case SOC_BLK_CGM:
            copyno_override = SOC_INFO(unit).brdc_cgm_block;
            break;
        case SOC_BLK_SCH:
            copyno_override = SOC_INFO(unit).brdc_sch_block;
            break;
        case SOC_BLK_EPNI:
            copyno_override = SOC_INFO(unit).brdc_epni_block;
            break;
        default:
            copyno = COPYNO_ALL;
        }
