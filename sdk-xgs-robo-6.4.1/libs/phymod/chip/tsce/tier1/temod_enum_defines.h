 ...
 */                                                                     
/*                                                                      
 * $Id: 5c7bddac99367f50ed913388970b1d12907bd672 $                                                             
...
temod_lane_select selects for programming, any combination of 4 lanes of PHY.
A '1' in the latter part of the enum name selects the lane.  Other parameters in
the #temod_st will decide what to do with the selected lane(s). In most cases
...
/*!
\brief
This array returns the string of #temod_os_mode when indexed by the enum.

*/
extern char* e2s_temod_os_mode_type [CNT_temod_os_mode_type];
/*!
\brief
This array returns the over sampling value of #temod_os_mode when indexed by
