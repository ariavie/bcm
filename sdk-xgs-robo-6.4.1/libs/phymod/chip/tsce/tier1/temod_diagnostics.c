...
#define _TRGC_(a,l) PHYMOD_DEBUG_ERROR((">> PHY TRG: Adr:%06d Ln:%02d\n",a,l));
  ...
  #define _TRG_OPN(a) _TRGO_(a->addr, a->lane)
  #define _TRG_CLS(a) _TRGC_(a->addr, a->lane)
  #define _TRG_LANE(a) (a->lane)
#endif
#ifdef _DV_TB_
...
int temod_diag_speed(PHYMOD_ST *pc)
{
  ...
  PHYMOD_DEBUG_ERROR(("| SPD CHG VLD  %d    |     OS MODE %-6s | DESCR MODE %-6s| SGMII SPD : %04d |\n",
     ...
     e2s_temod_os_mode_type[SC_X4_RSLVD0r_OS_MODEf_GET(sc_final_resolved_0)]+18,
...
{                                                                                                                          \
  ...
  x1_speed = (x1_speed >= TEMOD_SPD_ILLEGAL) ? TEMOD_SPD_ILLEGAL: x1_speed;                                                \
  PHYMOD_DEBUG_ERROR(("| ST [%d]              | %-28s| NUM LANES : %d            |\n",                                     \
       st_num, e2s_temod_spd_intfc_type[x1_speed]+6,                                                                       \
  ...
  if((resolved_speed == 0xff) || (resolved_speed==SC_X1_SPD_##ovr##_SPDr_SPEEDf_GET(sc_st##_speed))) { /* ST has Entry */  \
    ...
    READ_SC_X1_SPD_##ovr##_8r(pc,&sc_st##_8);                                                                              \
                                                                                                                           \
  PHYMOD_DEBUG_ERROR(("| %-19s | %-28s| SGMII SPD : %04d         |\n",                                                     \
        e2s_temod_os_mode_type[SC_X1_SPD_##ovr##_0r_OS_MODEf_GET(sc_st##_0)]+6,                                            \
        ...
        SC_X1_SPD_##ovr##_3r_SGMII_SPD_SWITCHf_GET(sc_st##_3)));                                                           \
                                                                                                                           \
  PHYMOD_DEBUG_ERROR(("| %-19s | %-28s|  CLK CNT0 : %04d         |\n",                                                     \
        ...
        SC_X1_SPD_##ovr##_3r_CLOCKCNT0f_GET(sc_st##_3)));                                                                  \
                                                                                                                           \
  PHYMOD_DEBUG_ERROR(("| %-19s | %-28s|  CLK CNT1 : %04d         |\n",                                                     \
        ...
        SC_X1_SPD_##ovr##_4r_CLOCKCNT1f_GET(sc_st##_4)));                                                                  \
			                                                                                                               \
  PHYMOD_DEBUG_ERROR(("| %-19s | %-28s|   LP CNT0 : %04d         |\n",                                                     \
...
int _get_no_of_pcs_lane(PHYMOD_ST* pc)
{
  ...
  switch(port_type) {
    ...
    case TEMOD_MULTI_PORT:      return 1;
    /* coverity[dead_error_begin] */
    case TEMOD_TRI1_PORT:       return ((port_num==2) ? 2:1);
    /* coverity[dead_error_begin] */
    case TEMOD_TRI2_PORT:       return ((port_num==0) ? 2:1);
    /* coverity[dead_error_begin] */
    case TEMOD_DXGXS:           return 2;
    /* coverity[dead_error_begin] */
    case TEMOD_SINGLE_PORT:     return 4;
    /* coverity[dead_error_begin] */
    default:                    return 0;
  }
  return 0;
