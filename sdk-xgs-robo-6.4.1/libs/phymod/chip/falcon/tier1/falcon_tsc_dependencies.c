 ...
 *  $Id: f667e1885f1330199414de1c74e1d12824be35e6 $
*/
...
void falcon_tsc_pmd_mwr_reg(const phymod_access_t *pa, uint16_t addr, uint16_t mask, uint8_t lsb, uint16_t val) {
...
void falcon_tsc_pmd_wr_reg(const phymod_access_t *pa, uint16_t address, uint16_t val){
