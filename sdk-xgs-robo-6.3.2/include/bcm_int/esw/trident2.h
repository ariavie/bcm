/*
 * $Id: trident2.h 1.65.4.1 Broadcom SDK $
...
/* VXLAN */
extern int bcm_td2_vxlan_udpDestPort_set(int unit, uint16 udpDestPort);
...
extern int 
bcm_td2_cosq_bst_stat_traverse(int unit, 
                               bcm_gport_t port, 
                               bcm_cos_queue_t cosq, 
                               uint32 flags,
