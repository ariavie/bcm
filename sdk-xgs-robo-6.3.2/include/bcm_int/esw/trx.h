...
extern int _bcm_lport_profile_entry_get(int unit, int index, int count,
                                        void **entries);
extern int _bcm_lport_profile_fields32_modify(int unit, int field_count,
                                              soc_field_t *fields,
                                              uint32 *values);
extern int _bcm_lport_profile_field32_modify(int unit,
                                             soc_field_t field,
                                             uint32 value);
