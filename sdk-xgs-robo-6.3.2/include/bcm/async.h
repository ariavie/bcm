 ...
 * Generated:	Tue Aug  6 19:02:42 2013
 */
...
void	bcm_cosq_bst_profile_get_async(int unit, bcm_gport_t port, bcm_cos_queue_t cosq, uint32 flags, bcm_cosq_bst_profile_t * profile, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_cosq_bst_profile_set_async(int unit, bcm_gport_t port, bcm_cos_queue_t cosq, uint32 flags, bcm_cosq_bst_profile_t * profile, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_cosq_bst_stat_get_async(int unit, bcm_gport_t port, bcm_cos_queue_t cosq, uint32 flags, uint64 * value, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_cosq_bst_stat_traverse_async(int unit, bcm_gport_t port, bcm_cos_queue_t cosq, uint32 flags, bcm_cosq_bst_stat_traverse_cb cb, void * user_data, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_fcoe_vsan_create_async(int unit, bcm_fcoe_vsan_t * vsan, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_fcoe_vsan_destroy_async(int unit, bcm_fcoe_vsan_t * vsan, bcm_async_cb_t async_callback, void *async_cookie);
