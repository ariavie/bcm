/*
 * $Id: drv.h 1.652.2.3 Broadcom SDK $
...
#define SOC_INFO_CHIP_XGS            (SOC_INFO_CHIP_XGS_FABRIC | \
    ...
    pbmp_t          subtag_pbm;             /* SubTag enabled port bitmap */
...
#define   SOC_F_RESET              (SOC_F_ATTACHED|SOC_F_INITED|SOC_F_POLLED|SOC_F_KNET_MODE)
    ...
    int             first_10gxe_port;       /* Logical port number of first 10G XE port */
    int             wc0_speed;
    int             wc1_speed;
    int             wc2_speed;
...
#define _SOC_SER_SRAM_CORRECTION_MODE_1 1 /* So called "modified" XOR scheme */
    int ram_count;
    int mem_indexes[_SOC_SER_MAX_SRAMS];
    int bank_index;
    soc_reg_t force_reg;
