...
bcm_esw_oam_loopback_add(int unit, bcm_oam_loopback_t *loopback_ptr)
{
    ...
    if ((soc_feature(unit, soc_feature_oam)) && (soc_feature(unit, soc_feature_bhh)))
    {
        ...
        if (SOC_IS_TRIUMPH3(unit)) {
            result = bcm_tr3_oam_loopback_add(unit, loopback_ptr);
        } else
#endif
        {
...
#if defined(BCM_TRIUMPH3_SUPPORT)
        if (SOC_IS_TRIUMPH3(unit)) {
            result = bcm_tr3_oam_loopback_get(unit, loopback_ptr);
        } else
#endif 
        {
#if defined(BCM_KATANA_SUPPORT)
...
#if defined(BCM_TRIUMPH3_SUPPORT)
        if (SOC_IS_TRIUMPH3(unit)) {
            result = bcm_tr3_oam_loopback_delete(unit, loopback_ptr);
        } else
#endif
        {
#if defined(BCM_KATANA_SUPPORT) 
    ...
    bcm_oam_loss_t *loss_ptr)
{
    ...
    {
        if (SOC_IS_TRIUMPH3(unit)) {
            result = bcm_tr3_oam_loss_add(unit, loss_ptr);
        } 
    }
#endif
    ...
    bcm_oam_loss_t *loss_ptr)
{
    ...
    {
        if (SOC_IS_TRIUMPH3(unit)) {
            result = bcm_tr3_oam_loss_delete(unit, loss_ptr);
        } 
    }
#endif
    ...
    bcm_oam_loss_t *loss_ptr)
{
    ...
    {
        if (SOC_IS_TRIUMPH3(unit)) {
            result = bcm_tr3_oam_loss_get(unit, loss_ptr);
        } 
    }
#endif
    ...
    bcm_oam_delay_t *delay_ptr)
{
    ...
    {
        if (SOC_IS_TRIUMPH3(unit)) {
            result = bcm_tr3_oam_delay_add(unit, delay_ptr);
        } 
    }
#endif
    ...
    bcm_oam_delay_t *delay_ptr)
{
    ...
    {
        if (SOC_IS_TRIUMPH3(unit)) {
            result = bcm_tr3_oam_delay_delete(unit, delay_ptr);
        } 
    }
#endif
    ...
    bcm_oam_delay_t *delay_ptr)
{
    ...
    {
        if (SOC_IS_TRIUMPH3(unit)) {
            result = bcm_tr3_oam_delay_get(unit, delay_ptr);
        } 
    }
#endif
