 ...
 *
 */
bcm_error_t bcm_esw_mim_lookup_id_stat_attach(
            int unit,
            int lookup_id,
 ...
 *
 */
bcm_error_t bcm_esw_mim_lookup_id_stat_detach(
            int unit,
            int lookup_id)
{
#if defined(BCM_TRIUMPH3_SUPPORT)
 ...
 *
 */
bcm_error_t bcm_esw_mim_lookup_id_stat_counter_get(
            int unit,
            int lookup_id,
            bcm_mim_stat_t stat,
            uint32 num_entries,
 ...
 *
 */
bcm_error_t bcm_esw_mim_lookup_id_stat_counter_set(
            int unit,
            int lookup_id,
            bcm_mim_stat_t stat,
            uint32 num_entries,
 ...
 *
 */
bcm_error_t bcm_esw_mim_lookup_id_stat_id_get(
            int unit,
            int lookup_id,
            bcm_mim_stat_t stat,
            uint32 *stat_counter_id)
 ...
 *
 */
bcm_error_t bcm_esw_mim_vpn_stat_attach(
            int unit,
            bcm_mim_vpn_t vpn,
            uint32 stat_counter_id)
{
 ...
 *
*/
bcm_error_t bcm_esw_mim_vpn_stat_detach(
            int unit,
            bcm_mim_vpn_t vpn)
{
#if defined(BCM_TRIUMPH3_SUPPORT)
 ...
 *
 */
bcm_error_t bcm_esw_mim_vpn_stat_counter_get(
            int unit,
            bcm_mim_vpn_t vpn,
            bcm_mim_stat_t stat,
            uint32 num_entries,
 ...
 *
 */
bcm_error_t bcm_esw_mim_vpn_stat_counter_set(
            int unit,
            bcm_mim_vpn_t vpn,
            bcm_mim_stat_t stat,
            uint32 num_entries,
 ...
 *
 */
bcm_error_t bcm_esw_mim_vpn_stat_id_get(
            int unit,
            bcm_mim_vpn_t vpn,
            bcm_mim_stat_t stat,
            uint32 *stat_counter_id)
