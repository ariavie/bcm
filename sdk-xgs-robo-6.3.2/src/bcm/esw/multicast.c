/*
 * $Id: multicast.c 1.138 Broadcom SDK $
...
#if defined(BCM_KATANA2_SUPPORT)
    int is_local_subport = FALSE, my_modid = 0;
#endif
    ...
    PBMP_ITER(l2_pbmp, port_iter) {
        ...
        if (NULL != port_array) {
            ...
            if ((soc_feature(unit, soc_feature_linkphy_coe) ||
                ...
                BCM_IF_ERROR_RETURN(bcm_kt2_subport_pp_port_subport_info_get(
                    unit, port_iter, &subport_info));
    ...
    *port_count = 0;
    ...
    BCM_PBMP_ITER(ether_higig_pbmp, port_iter) {
        ...
        if ((soc_feature(unit, soc_feature_linkphy_coe) ||
                ...
                (port_iter <= _BCM_KT2_SUBPORT_PP_PORT_INDEX_MAX)) {
            is_local_subport = TRUE;
            rv = bcm_kt2_subport_pp_port_subport_info_get(
                    unit, port_iter, &subport_info);
            if (BCM_FAILURE(rv)) {
                sal_free((void *)local_id_array);
                return rv;
            ...
            if (NULL != port_array) {
                ...
                if (is_local_subport) {
                    ...
                    _BCM_KT2_SUBPORT_PORT_ID_SET(port_array[*port_count + i],
                            port_iter);
                    _BCM_KT2_SUBPORT_PORT_TYPE_SET(port_array[*port_count + i],
                            subport_info.port_type);
                } else
#endif /* BCM_KATANA2_SUPPORT */
                {
    ...
    BCM_PBMP_ITER(l2_pbmp, port_iter) {
        ...
        if (NULL != port_array) {
            ...
            if (is_local_subport) {
                ...
                _BCM_KT2_SUBPORT_PORT_ID_SET(port_array[*port_count], port_iter);
