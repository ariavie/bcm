/*
 * $Id: nat.c 1.30.2.2 Broadcom SDK $
    ...
    void *user_data)
{
    ...
    if ((start > idx_max) || (end > idx_max) || (start > end)) {
        return BCM_E_PARAM;
    }
...
bcm_error_t  _bcm_td2_l3_nat_egress_stat_attach (
                            int                 unit,
                            bcm_l3_nat_egress_t	*info,
 ...
 *
 */
bcm_error_t  _bcm_td2_l3_nat_egress_stat_detach (
                            int                 unit,
                            bcm_l3_nat_egress_t	*info)
{
    int                        counter_flag = 0;
 ...
 *
 */
 bcm_error_t  _bcm_td2_l3_nat_egress_stat_counter_get(
                            int                 unit, 
                            bcm_l3_nat_egress_t	*info,
 ...
 *
 */
 bcm_error_t  _bcm_td2_l3_nat_egress_stat_counter_set(
                            int                 unit, 
                            bcm_l3_nat_egress_t	*info,
                            bcm_l3_nat_egress_stat_t  stat, 
                            uint32              num_entries, 
 ...
 */
 ...
 bcm_error_t  _bcm_td2_l3_nat_egress_stat_multi_get(
                            int                 unit, 
                            bcm_l3_nat_egress_t	*info,
                            int                 nstat, 
 ...
 *
 */
 bcm_error_t  _bcm_td2_l3_nat_egress_stat_multi_get32(
                            int                 unit, 
                            bcm_l3_nat_egress_t	*info,
                            int                 nstat, 
                            bcm_l3_nat_egress_stat_t  *stat_arr,
 ...
 *
 */
bcm_error_t  _bcm_td2_l3_nat_egress_stat_multi_set(
                            int                 unit, 
                            bcm_l3_nat_egress_t	*info,
                            int                 nstat, 
                            bcm_l3_nat_egress_stat_t    *stat_arr,
 ...
 */
 ...
 bcm_error_t  _bcm_td2_l3_nat_egress_stat_multi_set32(
                            int                 unit, 
                            bcm_l3_nat_egress_t	*info,
                            int                 nstat, 
                            bcm_l3_nat_egress_stat_t    *stat_arr,
 ...
 */
 ...
 bcm_error_t  _bcm_td2_l3_nat_egress_stat_id_get(
                            int                 unit,
                            bcm_l3_nat_egress_t	*info,
                            bcm_l3_nat_egress_stat_t    stat, 
                            uint32              *stat_counter_id) 
...
bcm_error_t  bcm_esw_l3_nat_egress_stat_attach (
                            int                 unit,
                            bcm_l3_nat_egress_t	*info,
                            uint32              stat_counter_id)
{
 ...
 *
 */
bcm_error_t  bcm_esw_l3_nat_egress_stat_detach (
                            int                 unit,
                            bcm_l3_nat_egress_t	*info)
{
int     rv = BCM_E_UNAVAIL;
 ...
 *
 */
 bcm_error_t  bcm_esw_l3_nat_egress_stat_counter_get(
                            int                 unit, 
                            bcm_l3_nat_egress_t	*info,
                            bcm_l3_nat_egress_stat_t    stat, 
                            uint32              num_entries, 
 ...
 *
 */
 bcm_error_t  bcm_esw_l3_nat_egress_stat_counter_set(
                            int                 unit, 
                            bcm_l3_nat_egress_t	*info,
                            bcm_l3_nat_egress_stat_t  stat, 
                            uint32              num_entries, 
 ...
 */
 ...
 bcm_error_t  bcm_esw_l3_nat_egress_stat_multi_get(
                            int                 unit, 
                            bcm_l3_nat_egress_t	*info,
                            int                 nstat, 
                            bcm_l3_nat_egress_stat_t  *stat_arr,
 ...
 *
 */
 bcm_error_t  bcm_esw_l3_nat_egress_stat_multi_get32(
                            int                 unit, 
                            bcm_l3_nat_egress_t	*info,
                            int                 nstat, 
                            bcm_l3_nat_egress_stat_t  *stat_arr,
 ...
 *
 */
bcm_error_t  bcm_esw_l3_nat_egress_stat_multi_set(
                            int                 unit, 
                            bcm_l3_nat_egress_t	*info,
                            int                 nstat, 
                            bcm_l3_nat_egress_stat_t    *stat_arr,
 ...
 */
 ...
 bcm_error_t  bcm_esw_l3_nat_egress_stat_multi_set32(
                            int                 unit, 
                            bcm_l3_nat_egress_t	*info,
                            int                 nstat, 
                            bcm_l3_nat_egress_stat_t    *stat_arr,
 ...
 */
 ...
 bcm_error_t  bcm_esw_l3_nat_egress_stat_id_get(
                            int                 unit,
                            bcm_l3_nat_egress_t	*info,
                            bcm_l3_nat_egress_stat_t    stat, 
                            uint32              *stat_counter_id) 
                                    ...
                                    void *user_data)
{
    ...
    if (soc_feature(unit, soc_feature_nat)) {
        ...
        if (start > (uint32)tbl_size || end > (uint32)tbl_size || start > end) {
            BCM_IF_ERROR_RETURN(_bcm_esw_l3_nat_unlock(unit));
            return (BCM_E_NOT_FOUND);
        }
