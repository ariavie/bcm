/*----------------------------------------------------------------------
 * $Id: tscmod_main.h 1.103.2.2 Broadcom SDK $
...
#define TSCMOD_CTRL_TYPE_DEFAULT          0x70000000
#define TSCMOD_CTRL_TYPE_MASK              0xfffffff
...
#define TSCMOD_CTRL_TYPE_ALL_PROXY          0x200000
#define TSCMOD_CTRL_TYPE_ALL_PROXY_BLK_ADR  0x400000
