/*
 * $Id: phy84793.c 1.7 Broadcom SDK $
...
_phy_84793_control_prbs_tx_invert_data_set(int32 unit, 
                                       soc_port_t port, PHY84793_INTF_SIDE intf_side,
                                       int32 invert);
STATIC int32 
...
STATIC int32 
_phy_84793_diag_dsc(int32 unit, soc_port_t port,
...
STATIC int32
_phy_84793_chage_div(int32 unit, soc_port_t port, uint16 setmode, uint16 refclkin);
                     ...
                     soc_phy_control_t type, uint32 *value)
{
    ...
    switch (type) {
        ...
        break;
        case SOC_PHY_CONTROL_LOOPBACK_REMOTE:
            rv = _phy_84793_per_lane_remote_lb_get(unit, port, pc->lane_num, value);
        break;
        case SOC_PHY_CONTROL_LOOPBACK_INTERNAL: 
                               ...
                               soc_phy_control_t type, uint32 *value)
{
    ...
    switch(type) {
        ...
        break;
        case SOC_PHY_CONTROL_PRBS_RX_STATUS:
	        rv = _phy_84793_per_lane_control_prbs_rx_status_get(unit, port, lane, value);
            break;
        case SOC_PHY_CONTROL_PORT_PRIMARY:
            SOC_IF_ERROR_RETURN
                (soc_phyctrl_primary_get(unit, port, &primary));
 ...
 */
STATIC int32 
_phy_84793_diag_dsc(int32 unit, soc_port_t port, int32 intf, int32 lane)
{
    int32 i = 0;
    int32 lanes = 0;
    uint32 reg_addr = 0;
 ...
 *      SOC_E_NONE
 */
int32 phy_84793_cmd_eye_monitor(int32 unit, int32 port, uint8 core, uint8 command, uint16 lane_mask)
{
	uint16 params;
	uint16 rddata = 0;
	uint16 count = 0;
 ...
 */
STATIC int32
_phy_84793_diag_eyescan_livelink_en(int unit, soc_port_t port, int16 intf, int16 lane, int en)
{
    uint16 lane_mask = 0;
 ...
 */
STATIC int32
_phy_84793_diag_eyescan_livelink_start(int unit, soc_port_t port, int16 intf, int16 lane)
{
    uint16 lane_mask = 0;
    phy_ctrl_t *pc = EXT_PHY_SW_STATE(unit, port);
    uint8 core_id = 0; 
 ...
 */
STATIC int32
_phy_84793_diag_eyescan_livelink_read(int unit, soc_port_t port, int16 intf, int16 lane, uint32 *err_counter)
{
    uint16 rdaddr = 0;
    uint16 rddata = 0;
    uint16 rddata1 = 0;
 ...
 */
STATIC int32
_phy_84793_diag_eyescan_max_left_hoffset_get(int unit, soc_port_t port, int *left_hoffset)
{
 ...
 */
STATIC int32
_phy_84793_diag_eyescan_max_right_hoffset_get(int unit, soc_port_t port, int *right_hoffset)
{
 ...
 */
STATIC int32
_phy_84793_diag_eyescan_min_voffset_get(int unit, soc_port_t port, int *min_voffset)
{
 ...
 */
STATIC int32
_phy_84793_diag_eyescan_max_voffset_get(int unit, soc_port_t port, int *max_voffset)
{
 ...
 */
STATIC int32
_phy_84793_diag_eyescan(int32 unit, soc_port_t port, uint32 inst, int32 op_cmd, void *arg)
{
    int32 rv = SOC_E_NONE;
    int16 intf = 0;
    int16 lane = 0, mode = 0;
                                                     ...
                                                     int32 op_cmd, void *arg)
{
    ...
    switch (op_cmd) {
        case PHY_DIAG_CTRL_DSC:
            SOC_IF_ERROR_RETURN(_phy_84793_diag_dsc(unit, port, intf, lane));
        break;
        case PHY_DIAG_CTRL_EYE_ENABLE_LIVELINK:
        case PHY_DIAG_CTRL_EYE_DISABLE_LIVELINK:
        case PHY_DIAG_CTRL_EYE_CLEAR_LIVELINK:
...
{ 
    ...
    if (lane <= PHY84793_VSR40_LANE3) {
        ...
        if ((mode == PHY84793_MODE_10X10G_TO_4X25G) || (mode == PHY84793_MODE_10X10G_TO_4X25G_OTL)) {
            return SOC_E_NONE;
        }
 ...
 * Purpose:
 *      To enable IEEE PRBS generator enable .
 * Parameters:
 *      unit  - StrataSwitch unit #.
 *      port  - StrataSwitch port #.
 *      lane  - lane number 
            ...
            if (lane < PHY84793_VSR40_LANE3) {
                ...
                SOC_IF_ERROR_RETURN
                 (_phy_84793_modify_pma_pmd_reg (unit, port, pc, RG_TX_TX_GB_TEST_GEN_CTRL, 
                  ...
                  RG_TX_TX_GB_TEST_GEN_CTRL_PRBS_INV_SHIFT + lane , (invert & (1<<lane)?1:0)));
            } else {
                if (mode == PHY84793_MODE_10X10G_TO_4X25G || mode == PHY84793_MODE_10X10G_TO_4X25G_OTL) {
                   return SOC_E_NONE;
                }
            ...
            if (lane < PHY84793_VSR40_LANE3) {
                ...
                SOC_IF_ERROR_RETURN
                 (_phy_84793_modify_pma_pmd_reg (unit, port, pc, RG_RX_RX_GB_PRBS_INV_IN,
                    ...
                    RG_RX_RX_GB_PRBS_INV_IN_PRBS_INV_IN_SHIFT + lane, (invert & (1<<lane)?1:0)));
            } else {
                if (mode == PHY84793_MODE_10X10G_TO_4X25G || mode == PHY84793_MODE_10X10G_TO_4X25G_OTL) {
                   return SOC_E_NONE;
                }
    ...
    switch (mode) {
        ...
        case PHY84793_MODE_10X10G_TO_4X25G_OTL:
            ...
            if ((rddata & (1 << lane)) != (1<<lane)) { /* If not locked */
                SOC_IF_ERROR_RETURN
                 (_phy_84793_modify_pma_pmd_reg (unit, port, pc, RG_RX_RX_GB_TEST_MISC_CTRL, 
                                                11, 8 ,(1 << lane)));
                SOC_IF_ERROR_RETURN
	    ...
	    case PHY84793_MODE_10X10G_TO_10X10G_ASYNC:		
            if (lane <= PHY84793_VSR40_LANE3) {
                ...
                SOC_IF_ERROR_RETURN
                    (_phy_84793_dc_hc_pcb_read (unit, port, pc, PHY84793_HEXA_CORE, reg_addr, 
                     PHY84793_DC_HC_RD_WIT_OUT_CLEAR, &rddata));
                prev_val = rddata;
                rddata  &= ~0x7;
                rddata |= 0x7;
                SOC_IF_ERROR_RETURN
                ...
                SOC_IF_ERROR_RETURN(
                        _phy_84793_dc_hc_pcb_read (unit, port, pc, PHY84793_HEXA_CORE, reg_addr, 
                        PHY84793_DC_HC_RD_WIT_CLEAR, &rddata));
                 ...
                 uint16 dc_hc, uint32 addr, uint16 clear_reg, uint16 *rddata) 
{
    ...
    if (dc_hc == PHY84793_HEXA_CORE) {/* For Rx HC*/
        SOC_IF_ERROR_RETURN
          (WRITE_PHY84793_PMA_PMD_REG(unit, pc, CTL_REGS_PCB_CTRL_TYPE, PHY84793_HC_RX_BIT));
        SOC_IF_ERROR_RETURN
          (WRITE_PHY84793_PMA_PMD_REG(unit, pc, CTL_REGS_PCB_CTRL_TYPE, PHY84793_HC_READ_ENABLE));
    } else {  /* FOR DC */
        SOC_IF_ERROR_RETURN
          (WRITE_PHY84793_PMA_PMD_REG(unit, pc, CTL_REGS_PCB_CTRL_TYPE, PHY84793_DC_ENABLE));
        SOC_IF_ERROR_RETURN
          (WRITE_PHY84793_PMA_PMD_REG(unit, pc, CTL_REGS_PCB_CTRL_TYPE, PHY84793_DC_READ_ENABLE));
    }
                              ...
                              uint16 mode)
{
    ...
    if (mode == PHY84793_MODE_10X10G_TO_4X25G) {
        ...
        /*SOC_IF_ERROR_RETURN(_phy_84793_chage_div(unit, port, 0, 0));*/
    } else {
        SOC_IF_ERROR_RETURN
          (_phy_84793_modify_pma_pmd_reg (unit, port, pc, CTL_REGS_USER_MODESEL_REG,
          CTL_REGS_USER_MODESEL_REG_USER_MODESEL_FRC_SHIFT, 
        ...
        SOC_IF_ERROR_RETURN(_phy_84793_chage_div(unit, port, 1, 0));
		...
		phy_ctrl_t *pc, uint16 cfg_tx_pol, uint16 cfg_rx_pol)
{
    ...
    if (PHY84793_POL_DND != cfg_tx_pol) {
        ...
        for (lane = PHY84793_DC_LANE0; lane <= PHY84793_DC_LANE9; lane ++) {
            ...
            SOC_IF_ERROR_RETURN
               (_phy_84793_modify_pma_pmd_reg (unit, port, pc, RG_RX_RX_GB_IO_BIT_CTRL,
                                     ...
                                     uint16 cfg_tx_pol, uint16 cfg_rx_pol)
{
    ...
    if (PHY84793_POL_DND != cfg_tx_pol) {
        ...
        for (lane = PHY84793_HC_LANE0; lane < PHY84793_LN_MAX_NO_LANE; lane ++) {
           ...
           SOC_IF_ERROR_RETURN
             (_phy_84793_modify_pma_pmd_reg(unit, port, pc, RG_TX_TX_GB_IO_BIT_CONTROL, 
                                  ...
                                  uint16 cfg_tx_set, uint16 cfg_rx_set)
{
    ...
    if (cfg_rx_set != PHY84793_ENABLE_SET_DND) {
        for (lane = PHY84793_HC_LANE0; lane < PHY84793_LN_MAX_NO_LANE;
            ...
            if (lane <= PHY84793_VSR40_LANE3) {
                SOC_IF_ERROR_RETURN
                   (_phy_84793_modify_pma_pmd_reg(unit, port, pc, CTL_REGS_FRC_VSR40_RX_PD, 
                   CTL_REGS_FRC_VSR40_RX_PD_FRC_VSR40_RX_PWRDN_SHIFT + lane, 
                   CTL_REGS_FRC_VSR40_RX_PD_FRC_VSR40_RX_PWRDN_SHIFT + lane, 1)); 
                SOC_IF_ERROR_RETURN
                   (_phy_84793_modify_pma_pmd_reg(unit, port, pc, CTL_REGS_VSR40_RX_PD, 
                ...
                SOC_IF_ERROR_RETURN
                   (_phy_84793_modify_pma_pmd_reg(unit, port, pc, CTL_REGS_FRC_HCRX_PD, 
    ...
    if (cfg_tx_set != PHY84793_ENABLE_SET_DND) {
        for (lane = PHY84793_HC_LANE0; lane < PHY84793_LN_MAX_NO_LANE; 
            ...
            if (lane <= PHY84793_VSR40_LANE3) {
                ...
                SOC_IF_ERROR_RETURN
                   (_phy_84793_modify_pma_pmd_reg(unit, port, pc, 
                    CTL_REGS_VSR40_TX_PD, (CTL_REGS_VSR40_TX_PD_VSR40_TX_PWRDN_SHIFT + lane),
                ...
                SOC_IF_ERROR_RETURN
                   (_phy_84793_modify_pma_pmd_reg(unit, port, pc, 
                    CTL_REGS_FRC_HCTX_PD, (CTL_REGS_FRC_HCTX_PD_FRC_HCTX_PWRDN_SHIFT + (lane-4)), 
                                   ...
                                   uint16 lane, uint32 value)
{
    ...
    if (intf_side == PHY84793_LINE_SIDE) {
        if (lane <= PHY84793_VSR40_LANE3) {   
            ...
            PHY_84793_HCTX_PCB_READ(unit,pc,tx_lane_base_add, &rddata); 
	        rddata = (rddata & 0xFE00) | ((main_tap & 0x3F) << 3) | ((post_cursor1>>2) & 0x7);
...
STATIC int32
_phy_84793_control_tx_driver_get (int32 unit, soc_port_t port, soc_phy_control_t type, 
                                  PHY84793_INTF_SIDE intf_side, 
                                  uint32 *value)
{
    phy_ctrl_t     *pc;
...
_phy_84793_rx_seq_done_get(int unit, soc_port_t port, int32 intf, uint32 *value)
{
    ...
    if (intf == PHY84793_LINE_SIDE) {
        ...
        for (lane = 0; lane <=9; lane ++) {
            ...
            SOC_IF_ERROR_RETURN(_phy_84793_dc_hc_pcb_write (unit, port, pc, PHY84793_DECA_CORE, 
                                         (lane<<16), rddata));
            sal_usleep(1000);
            SOC_IF_ERROR_RETURN(_phy_84793_dc_hc_pcb_read (unit, port,pc,
    ...
    switch (mode) {
        ...
        case PHY84793_MODE_4X10G_TO_4X10G:
            if (pc->lane_num == 0) {
                SOC_IF_ERROR_RETURN
                (_phy_84793_modify_pma_pmd_reg(unit, port, pc, 
                 CTL_REGS_LINE_LOOPBACK_EN, CTL_REGS_SYS_LOOPBACK_EN_SYS_LPBK_EN_SHIFT + 3,
                 CTL_REGS_SYS_LOOPBACK_EN_SYS_LPBK_EN_SHIFT, 
                  enable?0xf:0)); 
            } else {
                SOC_IF_ERROR_RETURN
                (_phy_84793_modify_pma_pmd_reg(unit, port, pc, 
                 CTL_REGS_LINE_LOOPBACK_EN, CTL_REGS_SYS_LOOPBACK_EN_SYS_LPBK_EN_SHIFT+8,
        ...
        case PHY84793_MODE_10X10G_TO_10X10G_ASYNC:
          SOC_IF_ERROR_RETURN
            (_phy_84793_modify_pma_pmd_reg(unit, port, pc, CTL_REGS_LINE_LOOPBACK_EN,
    ...
    switch (mode) {
        ...
        case PHY84793_MODE_4X10G_TO_4X10G:
            ...
            for (;start_lane <= end_lane; start_lane++) {
               /* Disable(Enable) Squelch when we  Enable(Disable) loopback */
                SOC_IF_ERROR_RETURN
                  (_phy_84793_line_lane_squelch_enable (unit, port, start_lane, enable));
 
                SOC_IF_ERROR_RETURN
                  (_phy_84793_modify_pma_pmd_reg(unit, port, pc, CTL_REGS_SYS_LOOPBACK_EN,
                  CTL_REGS_SYS_LOOPBACK_EN_SYS_LPBK_EN_SHIFT + start_lane ,
                  CTL_REGS_SYS_LOOPBACK_EN_SYS_LPBK_EN_SHIFT + start_lane, enable));
            }
        break;
        case PHY84793_MODE_10X10G_TO_10X10G_ASYNC:
              /* Disable(Enable) Squelch when we  Enable(Disable) loopback */
              SOC_IF_ERROR_RETURN
                  (_phy_84793_line_lane_squelch_enable (unit, port, pc->lane_num, enable));
...
int32 phy_84793_init(int32 unit, soc_port_t port)
{
	...
	POL_TX_CFG(pc) = (uint16) soc_property_port_get(unit, port, spn_PHY_TX_POLARITY_FLIP, PHY84793_POL_DND);
	POL_RX_CFG(pc) = (uint16) soc_property_port_get(unit, port, spn_PHY_RX_POLARITY_FLIP, PHY84793_POL_DND);
...
phy_84793_enable_set(int32 unit, soc_port_t port, int32 enable)
{
    ...
    if (mode == PHY84793_MODE_10X10G_TO_10X10G_ASYNC) {
        ...
        SOC_IF_ERROR_RETURN(_phy_84793_line_enable_set (unit, port, pc, 
			tx_data, rx_data)); 
    } else if (mode == PHY84793_MODE_10X10G_TO_10X10G_ASYNC) {
        if(pc->lane_num == 0) {
            start_lane = PHY84793_VSR40_LANE0;
            end_lane = PHY84793_VSR40_LANE3;
        } else {
    ...
    switch(pif) 
    {
        case SOC_PORT_IF_SR4:
            if (intf->speed == PHY84793_MODE2_SPD) {
                ...
                SOC_IF_ERROR_RETURN
                 (_phy_84793_config_mode (unit, port, pc, PHY84793_MODE_4X10G_TO_4X10G));
            } else {
                soc_cm_print("PHY84793 MODE1 Configured\n");
                SOC_IF_ERROR_RETURN
                 (_phy_84793_config_mode (unit, port, pc, PHY84793_MODE_10X10G_TO_4X25G));
        ...
        case SOC_PORT_IF_SR10:
            ...
            SOC_IF_ERROR_RETURN
             (_phy_84793_config_mode (unit, port, pc, PHY84793_MODE_10X10G_TO_10X10G_SYNC));
        ...
        case SOC_PORT_IF_SR:
            ...
            SOC_IF_ERROR_RETURN
             (_phy_84793_config_mode (unit, port, pc, PHY84793_MODE_10X10G_TO_10X10G_ASYNC));
            intf->speed = PHY84793_MODE4_SPD;
        break;
        case SOC_PORT_IF_OTL:
            soc_cm_print("PHY84793 MODE5 Configured\n");
            SOC_IF_ERROR_RETURN
             (_phy_84793_config_mode (unit, port, pc, PHY84793_MODE_10X10G_TO_4X25G_OTL));
...
STATIC int32 
_phy_84793_per_lane_remote_lb_get(int32 unit, soc_port_t port, uint16 lane, uint32 *enable)
{
    uint16 mode = 0, tmp = 0;
    phy_ctrl_t *pc;
    pc = EXT_PHY_SW_STATE(unit, port);
                    ...
                    uint16 clr_reg, uint16 *data)
{
    ...
    SOC_IF_ERROR_RETURN 
        (WRITE_PHY84793_PMA_PMD_REG(unit, pc, CTL_REGS_PCB_CTRL_TYPE, power(2,core_sel)));
    SOC_IF_ERROR_RETURN 
        (WRITE_PHY84793_PMA_PMD_REG(unit, pc, CTL_REGS_PCB_CTRL_TYPE, 
...
_phy_84793_chage_div(int32 unit, soc_port_t port, uint16 setmode, uint16 refclkin)
{
	...
	/* Assert RX CMU Reset*/
	SOC_IF_ERROR_RETURN
        (_phy_84793_modify_pma_pmd_reg (unit, port, pc, VSR40_RX_DIG_REGS_RESET_CONTROL,
    ...
    /* Force for refDiv*/
	SOC_IF_ERROR_RETURN(_phy_84793_modify_pma_pmd_reg (unit, port, pc, VSR40_TX_PLL_CONTROL1, 
                VSR40_RX_PLL_CONTROL1_SUSM_RX_REF_DIV_FRC_SHIFT, 
                VSR40_RX_PLL_CONTROL1_SUSM_RX_REF_DIV_FRC_SHIFT, setmode));  	
    SOC_IF_ERROR_RETURN(_phy_84793_modify_pma_pmd_reg (unit, port, pc, VSR40_TX_PLL_CONTROL1, 
                VSR40_RX_PLL_CONTROL1_SUSM_RX_REF_DIV_SHIFT+1 , 
	...
	SOC_IF_ERROR_RETURN
        (_phy_84793_modify_pma_pmd_reg (unit, port, pc, VSR40_TX_DIG_REGS_RESET_CONTROL, 
