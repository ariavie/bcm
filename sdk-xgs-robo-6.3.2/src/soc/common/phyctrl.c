/*
 * $Id: phyctrl.c 1.156 Broadcom SDK $
...
int soc_phyctrl_software_reconfig(int unit)
{
    int     port;
...
soc_phyctrl_software_init(int unit)
{
    ...
    if (!SAL_BOOT_RECONFIG_TDM) {
       ...
       soc_phyctrl_software_reconfig(unit);
    } /* !SAL_BOOT_RECONFIG_TDM */
#endif
