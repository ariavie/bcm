/*
 * $Id: enduro.c 1.124.6.1 Broadcom SDK $
...
soc_enduro_mem_config(int unit)
{
    ...
    case BCM56231_DEVICE_ID:
        ...
        sop->memState[L3_DEFIP_ONLYm].index_max = 1023;
        sop->memState[L3_DEFIP_DATA_ONLYm].index_max = 1023;
        sop->memState[L3_DEFIP_HIT_ONLYm].index_max = 1023;        
