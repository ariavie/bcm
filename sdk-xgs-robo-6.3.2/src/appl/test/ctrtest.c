/*
 * $Id: ctrtest.c 1.42 Broadcom SDK $
...
#if defined(BCM_ROBO_SUPPORT) || defined(BCM_ESW_SUPPORT) || defined(BCM_SIRIUS_SUPPORT) || defined(BCM_ARAD_SUPPORT)
    int			r;
...
#if defined(BCM_ESW_SUPPORT) || defined(BCM_SIRIUS_SUPPORT) || defined(BCM_ARAD_SUPPORT)
