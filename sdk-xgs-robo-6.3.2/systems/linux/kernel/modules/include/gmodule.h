/*
 * $Id: gmodule.h 1.10 Broadcom SDK $
...
{
        return proc_create(name, mode, parent, NULL);
}

static inline struct proc_dir_entry *create_proc_read_entry(
	const char *name,umode_t mode, struct proc_dir_entry *base,void *read_proc, void * data)
{
