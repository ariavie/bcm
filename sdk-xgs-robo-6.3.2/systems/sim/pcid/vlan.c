                                  ...
                                  vlan_xlate_entry_t *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "VLAN_XLAEGT Insert\n");
                                  ...
                                  vlan_xlate_entry_t *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "soc_internal_vlan_xlate_entry_del: Not found\n");
                                   ...
                                   vlan_xlate_entry_t *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "soc_internal_vlan_xlate_entry_lkup: Not found\n");
                                      ...
                                      uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "soc_internal_egr_vlan_xlate_entry_del: Not found\n");
                                       ...
                                       uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "soc_internal_egr_vlan_xlate_entry_lkup: Not found\n");
                                     ...
                                     int dual)
{
    ...
    debugk(DK_VERBOSE, "ING_VP_VLAN_MEMBERSHIP hash\n");

    reg = ING_VP_VLAN_MEMBERSHIP_HASH_CONTROLr;
    field = dual ? HASH_SELECT_Bf : HASH_SELECT_Af;

    addr = soc_reg_addr_get(pcid_info->unit, reg, REG_PORT_ANY, 0, &blk,
                            &acc_type);
                                    ...
                                    void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "ING_VP_VLAN_MEMBERSHIP Insert\n");
                                    ...
                                    void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "ING_VP_VLAN_MEMBERSHIP Delete\n");
    ...
    debugk(DK_VERBOSE, "soc_internal_ing_vp_vlan_member_del: "
           "Not found\n");
                                     ...
                                     void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "ING_VP_VLAN_MEMBERSHIP Lookup\n");
    ...
    debugk(DK_VERBOSE, "soc_internal_ing_vp_vlan_member_lkup: Not found\n");
                                     ...
                                     int dual)
{
    ...
    debugk(DK_VERBOSE, "EGR_VP_VLAN_MEMBERSHIP hash\n");
                                    ...
                                    void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "EGR_VP_VLAN_MEMBERSHIP Insert\n");
                                    ...
                                    void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "EGR_VP_VLAN_MEMBERSHIP Delete\n");
    ...
    debugk(DK_VERBOSE, "soc_internal_egr_vp_vlan_member_del: "
           "Not found\n");
                                     ...
                                     void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "EGR_VP_VLAN_MEMBERSHIP Lookup\n");
    ...
    debugk(DK_VERBOSE, "soc_internal_egr_vp_vlan_member_lkup: Not found\n");
                                        ...
                                        int dual)
{
    ...
    debugk(DK_VERBOSE, "ING_DNAT_ADDRESS_TYPE hash\n");
                                       ...
                                       void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "ING_DNAT_ADDRESS_TYPE Insert\n");
                                    ...
                                    void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "ING_DNAT_ADDRESS_TYPE Delete\n");
    ...
    debugk(DK_VERBOSE, "soc_internal_ing_dnat_address_type_del: "
           "Not found\n");
                                     ...
                                     void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "ING_DNAT_ADDRESS_TYPE Lookup\n");
    ...
    debugk(DK_VERBOSE, "soc_internal_ing_dnat_address_type_lkup: Not found\n");
                                 ...
                                 int dual)
{
    ...
    debugk(DK_VERBOSE, "L2_ENDPOINT_ID hash\n");
                                ...
                                void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "L2_ENDPOINT_ID Insert\n");
                                ...
                                void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "L2_ENDPOINT_ID Delete\n");
    ...
    debugk(DK_VERBOSE, "soc_internal_l2_endpoint_id_del: "
           "Not found\n");
                                 ...
                                 void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "L2_ENDPOINT_ID Lookup\n");
    ...
    debugk(DK_VERBOSE, "soc_internal_l2_endpoint_id_lkup: Not found\n");
                                     ...
                                     int dual)
{
    ...
    debugk(DK_VERBOSE, "ENDPOINT_QUEUE_MAP hash\n");
                                    ...
                                    void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "ENDPOINT_QUEUE_MAP Insert\n");
                                    ...
                                    void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "ENDPOINT_QUEUE_MAP Delete\n");
    ...
    debugk(DK_VERBOSE, "soc_internal_endpoint_queue_map_del: "
           "Not found\n");
                                     ...
                                     void *entry, uint32 *result)
{
    ...
    debugk(DK_VERBOSE, "ENDPOINT_QUEUE_MAP Lookup\n");
    ...
    debugk(DK_VERBOSE, "soc_internal_endpoint_queue_map_lkup: Not found\n");
